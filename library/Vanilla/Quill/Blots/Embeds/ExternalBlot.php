...
class ExternalBlot extends AbstractBlockEmbedBlot {
    ...
    protected function renderContent(array $data): string {
        ...
        try {
            ...
            $rendered = <<<HTML
<div contenteditable="false" class="embed embed-external embedExternal"><div class="embedExternal-content embed-{$type}" contenteditable="false">{$embedRendered}</div></div>
HTML;
        } catch (\Exception $e) {
